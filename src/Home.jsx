...
const Home = () => {
  const { data: books, isPending } = useFetch("http://localhost:8080/api/v1/booksList/");
console.log(books);
  return (
    <>
      <div className="container col-9 py-0">
        <div className="main-content">
          ...
          <div className="tab-content" id="myTabContent">
            ...
            >
              <div className="row">
              {isPending && <i className="fa-solid fa-spinner fa-spin-pulse fiftypx"></i>}
                  { books && books.map((book) => (
                <div className="card col-lg-3 col-md-4 col-sm-6 p-0 mt-3">
                
                      <img
                        className="hist_img"
                        src="https://m.media-amazon.com/images/I/71ecqHMyQ6L._AC_UF1000,1000_QL80_.jpg" height='250vh'
                        alt="book_photo"
                      />
